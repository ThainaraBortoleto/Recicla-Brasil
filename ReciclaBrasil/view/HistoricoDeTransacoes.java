...
public class HistoricoDeTransacoes extends JFrame {
	...
	public HistoricoDeTransacoes() throws SQLException{
		super("ReciclaBrasil");
		try(Connection con = new ConexaoBD().conectar()){
			...
			lblJose = new JLabel("José da Silva");
			...
			lblAlex = new JLabel("Alex Monteiro");
			...
			lblVinteEQuatro = new JLabel("24.75");
			...
			lblQuinzeKleber = new JLabel("15.00");
			...
			lblVidroNascimento = new JLabel("Vidro");
			...
			lblPlasticoLima = new JLabel("Plástico");
			...
			lblQuinzeLima = new JLabel("15.00");
