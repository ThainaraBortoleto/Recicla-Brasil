...
public class Home extends JFrame {
	...
	private JMenuItem pagInicial, cadastrarColetor, consultarColetor, cadastrarEmpresa, consultarEmpresa, ajusteValor,
			sair;
	private JLabel lblAluminio, lblPapelao, lblPlastico, lblVidro, lblTotalDeMaterial, lblIncio, lblPainelDeControle, porcentagemAluminio, porcentagemPapelao, porcentagemPlastico, porcentagemVidro,
			lblAgenda, lblCopyRight,
			lblDesenvolvedores;
	...
	public Home() throws SQLException {
		...
		try(Connection con = new ConexaoBD().conectar()){
			...
			Object[][] data = { { "09:00", eDao.listarNome(e1Id) }, { "10:00", null }, { "11:00", null }, { "12:00", null },
					{ "13:00", null }, { "14:00", null }, { "15:00", eDao.listarNome(e2Id) }, { "16:00", null }, { "17:00", null },
					{ "18:00", null }
