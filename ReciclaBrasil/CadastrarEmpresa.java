...
public class CadastrarEmpresa extends JFrame {
	...
	private JLabel lblIncio, lblPainelDeControle, lblCopyRight, lblDesenvolvedores, lblNomeCadastro, lblTelefone, lblCep, lblEndereco, lblEmail, lblNomeResponsavel, lblCnpj;
	private Observador observador;
	private JLabel lblCadastrarColetor;
	private JPanel panel_1;
	private JTextField textField;
	private JLabel lblRazaoSocial;
	private JTextField textField_1, txtNome, txtRazaoSocial, txtTelefone, txtCep, txtEndereco, txtEmail, txtNomeResponsavel, txtCnpj;
	...
	public CadastrarEmpresa() {
		...
		lblPainelDeControle = new JLabel("Cadastrar Empresa");
		lblPainelDeControle.setBounds(75, 12, 130, 16);
		...
		lblCadastrarColetor = new JLabel("Cadastrar Empresa");
		...
		lblNomeResponsavel.setBounds(180, 333, 600, 100);
		lblNomeResponsavel.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		panel.add(lblNomeResponsavel);
		
		txtNome = new JTextField(30);
		txtNome.setForeground(Color.GRAY);
		txtNome.setBounds(350, 90, 470, 20);
		...
		txtRazaoSocial.setBounds(350, 130, 470, 20);
		...
		txtCnpj.setBounds(350, 170, 470, 20);
		txtCnpj.setBackground(new Color(248, 248, 255));
		txtCnpj.setFont(new Font("Arial", Font.ITALIC, 12));
		panel.add(txtCnpj);

		txtTelefone = new JTextField(30);
		txtTelefone.setForeground(Color.GRAY);
		txtTelefone.setBounds(350, 210, 470, 20);
		...
		txtCep.setBounds(350, 250, 470, 20);
		...
		txtEndereco.setBounds(350, 290, 470, 20);
		...
		txtEmail.setBounds(350, 330, 470, 20);
