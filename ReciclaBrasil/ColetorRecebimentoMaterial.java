...
public class ColetorRecebimentoMaterial extends JFrame {
	...
	public ColetorRecebimentoMaterial() throws SQLException {
		super("ReciclaBrasil");
			...
			try (Connection con = new ConexaoBD().conectar()) {
				if (e.getSource() == pagInicial) {
					...
					if (selectValue.equalsIgnoreCase("Alumínio")) {
						...
						mDao.aumentaQuantidade(aluminio, quantidade);
						cDao.setSaldo(c1, aluminio, quantidade);
					...
					if (selectValue.equalsIgnoreCase("Papelão")) {
						...
						mDao.aumentaQuantidade(papelao, quantidade);
						cDao.setSaldo(c1, papelao, quantidade);
						lblTotalValor.setText(String.format("R$ %.2f", cDao.getSaldo(c1)));
						pesoTextField.setText("");
					...
					if (selectValue.equalsIgnoreCase("plástico")) {
						...
						mDao.aumentaQuantidade(plastico, quantidade);
						cDao.setSaldo(c1, plastico, quantidade);
						lblTotalValor.setText(String.format("R$ %.2f", cDao.getSaldo(c1)));
						pesoTextField.setText("");
					...
					if (selectValue.equalsIgnoreCase("vidro")) {
						...
						mDao.aumentaQuantidade(vidro, quantidade);
						cDao.setSaldo(c1, vidro, quantidade);
						lblTotalValor.setText(String.format("R$ %.2f", cDao.getSaldo(c1)));
						pesoTextField.setText("");
