...
public class FolhaDePagamentoEmpresa extends JFrame {
	...
	private JButton compraMaterialButton, folhaPagButton, histDeTransacoesButton, editCadastroButton, sacarButton;
	private Observador observador;
	private EmpresaDAO eDao;
	private Empresa e1; 

	public FolhaDePagamentoEmpresa() throws SQLException{
		super("ReciclaBrasil");
			...
			try(Connection con = new ConexaoBD().conectar()){
				if (e.getSource() == pagInicial) {
					...
					if(eDao.getValorAPagar(e1) > 0) {
						...
						JOptionPane.showMessageDialog(null, "Não possui dívida");
					}
